...
const ColorGoogleIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} role="img" viewBox="0 0 268.152 273.883" xmlns="http://www.w3.org/2000/svg">
    <title>Google</title>
    <defs>
      <linearGradient id="a">
...
export default ColorGoogleIcon;
